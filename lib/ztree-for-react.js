...
var _expose$Jquery = require('expose?$!jquery');
...
var ReactZtree = function (_Component) {
  ...
  _createClass(ReactZtree, [{
    ...
    value: function renderZtreeDom() {
      var ztreeObj = this.ztreeObj = _expose$Jquery2.default.fn.zTree.init(this.getTreeDom(), this.getTreeSetting(), this.props.nodes);
      return ztreeObj;
    }
  }, {
    key: 'getTreeDom',
    value: function getTreeDom() {
      return (0, _expose$Jquery2.default)(this.refs.ztree);
    }
  }, {
    key: 'getTreeSetting',
    ...
    value: function render() {
      return _react2.default.createElement('div', { className: 'ztree', ref: 'ztree', id: 'ztree' });
    }
  }]);
